...
public class RedisUtils {
    ...
    /**
     * 从redis中随机获取指定count数据，不删除
     *
     * @param key 指定key
     * @param count 要获取记录数量
     * @return
     */
    public List<String> getMembers(String key, int count) {
     ...
     * @return
     */
    public Set<String> popSet(String key, long count) {
        ShardedJedis shardedJedis = null;
        try {
            shardedJedis = shardedJedisPool.getResource();
